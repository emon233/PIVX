...
class DIP3Test(LynxTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-5, "invalid LYNX address InvalidPayee",
        ...
        assert_raises_rpc_error(-5, "invalid LYNX address InvalidPayee", controller.protx_update_registrar,
