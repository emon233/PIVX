...
"""Verify that starting lynx with -h works as expected."""
...
class HelpTest(LynxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start lynx with -? for help text")
        ...
        self.log.info("Start lynx with -version for version information")
