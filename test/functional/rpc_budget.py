...
class BudgetProposalTest(LynxTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test with invalid LYNX address")
        assert_raises_rpc_error(-5, "Invalid LYNX address", self.nodes[0].preparebudget,
