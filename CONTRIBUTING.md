...
The LYNX Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/lynx-project/lynx/blob/master/doc/translation_process.md)
...
The following applies to code changes to the LYNX Core project, and is not to be
confused with overall LYNX Network Protocol consensus changes.

Whether a pull request is merged into LYNX Core rests with the project merge
...
Patches that change LYNX consensus rules are considerably more involved than
...
Where a patchset proposes to change the LYNX consensus, it must have been
...
The project leader is the release manager for each LYNX Core release.
