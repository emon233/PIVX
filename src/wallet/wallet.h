...
#ifndef LYNX_WALLET_H
#define LYNX_WALLET_H
...
enum WalletFeature {
    ...
    FEATURE_PRE_LYNX = 61000, // inherited version..
...
public:
     ...
     * LYNX: group coins by pair <CTxDestination, Optional<CTxDestination>>. The optional destination
