...
// Copyright (c) 2016-2021 The LYNX Core developers
...
public:
    ...
    /**
     * Amount of lynx coming in to a transaction
...
// LYNX: When check is false, this assumes that overwrites are never possible due to BIP34 always in effect
