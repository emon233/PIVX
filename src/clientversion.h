...
#error Client version information missing: version is not defined by lynx-config.h or in any other way
#endif
...
/**
 * lynxd-res.rc includes this file, but it cannot cope with real c++ code.
