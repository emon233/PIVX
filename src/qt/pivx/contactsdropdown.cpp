...
#include "qt/lynx/contactdropdownrow.h"
...
ContactsDropdown::ContactsDropdown(int minWidth, int minHeight, LYNXGUI* _window, QWidget* _parent) : PWidget(_window, _parent)
{
