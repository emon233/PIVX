...
#ifndef LYNX_CORE_NEW_GUI_LYNXGUI_H
#define LYNX_CORE_NEW_GUI_LYNXGUI_H
...
/**
  LYNX GUI main class. This class represents the main window of the LYNX UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class LYNXGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit LYNXGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~LYNXGUI();
...
#endif //LYNX_CORE_NEW_GUI_LYNXGUI_H
