...
#include "qt/lynx/forms/ui_dashboardwidget.h"
#include "qt/lynx/sendconfirmdialog.h"
#include "qt/lynx/txrow.h"
...
DashboardWidget::DashboardWidget(LYNXGUI* parent) :
    PWidget(parent),
...
bool hasCharts = false;
    ...
    if (window)
        connect(window, &LYNXGUI::windowResizeEvent, this, &DashboardWidget::windowResizeEvent);
#endif
