...
#include "qt/lynx/forms/ui_topbar.h"
#include "qt/lynx/lockunlock.h"
#include "qt/lynx/qtutils.h"
#include "qt/lynx/receivedialog.h"
#include "qt/lynx/loadingdialog.h"
#include "askpassphrasedialog.h"

#include "bitcoinunits.h"
#include "qt/lynx/balancebubble.h"
...
TopBar::TopBar(LYNXGUI* _mainWindow, QWidget *parent) :
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("LYNX")
    updateDisplayUnit();
