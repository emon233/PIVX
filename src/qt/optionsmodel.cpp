...
void OptionsModel::setDisplayDefaultOptions(QSettings& settings, bool reset)
{
    ...
    if (settings.contains("nAnonymizeLynxAmount") || reset)
        gArgs.SoftSetArg("-anonymizelynxamount", settings.value("nAnonymizeLynxAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in lynx.cpp during shutdown to also remove the window positions
