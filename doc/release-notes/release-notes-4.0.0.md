PIVX Core version *v4.0.0* is now available from:  <https://github.com/lynx-project/lynx/releases>
...
For our linux users, in addition to the [Ubuntu PPA](https://launchpad.net/~lynx) repository, we are now offering a [Snap package](https://snapcraft.io/lynx-core) as quick way to install and update a PIVX wallet.
