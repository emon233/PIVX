...
with certain assembly code from LYNX Core's code. See [developer notes on sanitizers](https://github.com/LYNX-Project/LYNX/blob/master/doc/developer-notes.md#sanitizers)
