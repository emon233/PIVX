...
lynx.conf           | contains configuration settings for lynxd or lynx-qt
lynxd.pid           | stores the process id of lynxd while running
...
debug.log           | contains debug information and general logging generated by lynxd or lynx-qt
