...
*Setup instructions for a gitian build of LYNX Core using a VM or physical system.*

Gitian is the deterministic build process that is used to build the LYNX
...
to the LYNX GitHub release page.
...
- [Building LYNX Core](#building-lynx-core)
