...
RESOURCES += src/qt/lynx.qrc src/qt/lynx_locale.qrc

TRANSLATIONS += src/qt/locale/lynx_bg.ts \
                src/qt/locale/lynx_de.ts \
                src/qt/locale/lynx_en.ts \
                src/qt/locale/lynx_es.ts \
                src/qt/locale/lynx_fi.ts \
                src/qt/locale/lynx_fr.ts \
                src/qt/locale/lynx_it.ts \
                src/qt/locale/lynx_ja.ts \
                src/qt/locale/lynx_pl.ts \
                src/qt/locale/lynx_pt.ts \
                src/qt/locale/lynx_ru.ts \
                src/qt/locale/lynx_sk.ts \
                src/qt/locale/lynx_sv.ts \
                src/qt/locale/lynx_vi.ts \
                src/qt/locale/lynx_zh_CN.ts \
                src/qt/locale/lynx_zh_TW.ts
