...
This means one can have an always-on lynxd instance running, and another local lynxd/lynx-qt instance which connects to this node and receives blocks from it.
